                ...
                <ul class="side-menu app-sidebar3">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu ">
                            ...
                            <li><a href="#" class="slide-item"> Add Pickup Location</a></li>
							<!-- FOR ADMIN ONLY END -->
					...
					<!-- WALLET -->
                    <li class="side-item side-item-category">WALLET</li>
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="index-2.html#">
                            <svg class="side-menu__icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                viewBox="0 0 24 24" width="24">
                            ...
                            <span class="side-menu__label">Wallet Management</span><i class="angle fa fa-angle-right"></i></a>
                        <ul class="slide-menu ">
                            <li><a href="calendar.html" class="slide-item">Wallet Adjustment</a></li>
                            <li><a href="calendar.html" class="slide-item">Transaction History</a></li>
							<li><a href="calendar.html" class="slide-item"> Recharge Wallet</a></li>
                            <li><a href="calendar.html" class="slide-item">My Transaction History</a></li>
                        </ul>
                    </li>   
					<!-- WALLET END-->
